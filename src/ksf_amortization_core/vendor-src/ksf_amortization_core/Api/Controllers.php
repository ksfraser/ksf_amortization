    ...
    public function generate(array $requestData): ApiResponse {
        try {
            ...
            switch ($request->format) {
                case 'csv':
                    $content = $this->generateCsvReport($request);
                    break;
                case 'xml':
                    $content = $this->generateXmlReport($request);
                    break;
                case 'html':
                    $content = $this->generateHtmlReport($request);
                    break;
                default:
                    $content = $this->generateJsonReport($request);
                    break;
            }
